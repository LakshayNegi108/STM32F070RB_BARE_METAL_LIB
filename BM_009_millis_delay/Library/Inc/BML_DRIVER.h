...
#define ALT_FUN_0					AF[0]
#define ALT_FUN_1					0x01
#define ALT_FUN_2					AF[2]
#define ALT_FUN_3					AF[3]
#define ALT_FUN_4					AF[4]
#define ALT_FUN_5					AF[5]
#define ALT_FUN_6					AF[6]
#define ALT_FUN_7					AF[7]
...
typedef struct{				 // TIMER typedef structure
...
void gpio_config(GPIO_TypeDef *port, uint32_t pinNumber, uint32_t pinMode, uint32_t pinSpeed, uint32_t pinPUPD);
...
void gpio_altfn(GPIO_TypeDef *port, uint32_t pinNumber,uint32_t alternate_function);
//====================================================================================//
...
void timer_config(TIMER_TYPE *tim, uint32_t  prescaler_val, uint32_t auto_reload_val);
