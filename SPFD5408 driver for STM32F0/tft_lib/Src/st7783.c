...
//#define LCD_CS_HIGH()     LCD_CS_GPIO_PORT->BSRR = (1 << LCD_CS_PIN)
//#define LCD_CS_LOW()      LCD_CS_GPIO_PORT->BSRR = (1 << (LCD_CS_PIN + 16))
#define LCD_CS_HIGH()     gpio_write(LCD_CS_GPIO_PORT, 0, HIGH)
#define LCD_CS_LOW()      gpio_write(LCD_CS_GPIO_PORT, 0, LOW)

#define LCD_RD_GPIO_PORT  GPIOA
//#define LCD_RD_HIGH()     LCD_RD_GPIO_PORT->BSRR = (1 << LCD_RD_PIN)
//#define LCD_RD_LOW()      LCD_RD_GPIO_PORT->BSRR = (1 << (LCD_RD_PIN + 16))
#define LCD_RD_HIGH()      gpio_write(LCD_RD_GPIO_PORT, 0, HIGH)
#define LCD_RD_LOW()       gpio_write(LCD_RD_GPIO_PORT, 0, LOW)

#define LCD_WR_GPIO_PORT  GPIOA
//#define LCD_WR_HIGH()	  LCD_WR_GPIO_PORT->BSRR = (1 << LCD_WR_PIN)
//#define LCD_WR_LOW()      LCD_WR_GPIO_PORT->BSRR = (1 << (LCD_WR_PIN + 16))
#define LCD_WR_HIGH()	   gpio_write(LCD_WR_GPIO_PORT, 1, HIGH)
#define LCD_WR_LOW()       gpio_write(LCD_WR_GPIO_PORT, 1, LOW)

#define LCD_CD_GPIO_PORT  GPIOA
//#define LCD_CD_HIGH()     LCD_CD_GPIO_PORT->BSRR = (1 << LCD_CD_PIN)
//#define LCD_CD_LOW()      LCD_CD_GPIO_PORT->BSRR = (1 << (4 + 16))
#define LCD_CD_HIGH()      gpio_write(LCD_CD_GPIO_PORT, 4, HIGH)
#define LCD_CD_LOW()       gpio_write(LCD_CD_GPIO_PORT, 4, LOW)

#define LCD_RST_GPIO_PORT GPIOC
//#define LCD_RST_HIGH()    LCD_RST_GPIO_PORT->BSRR = (1 << LCD_RST_PIN)
//#define LCD_RST_LOW()     LCD_RST_GPIO_PORT->BSRR = (1 << (LCD_RST_PIN + 16))
#define LCD_RST_HIGH()     gpio_write(LCD_RST_GPIO_PORT, 1, HIGH)
#define LCD_RST_LOW()      gpio_write(LCD_RST_GPIO_PORT, 1, LOW)
...
//	gpio_config(PORTA, 2, OUTPUT_MODE, HIGH_SPEED, DI_PUPD, PHPL);
